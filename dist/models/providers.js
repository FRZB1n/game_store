...
class provider_db {
    constructor() {
        provider_db.con = Connect_1.default.get_con();
    }
    update(obj) {
        return __awaiter(this, void 0, void 0, function* () {
            let sql = "UPDATE `providers` SET ";
            let params = [];
            ...
            console.log(sql);
            const [res, f] = yield (yield provider_db.con).query(sql, params);
            return res;
        });
    }
    insert(obj) {
        return __awaiter(this, void 0, void 0, function* () {
            let sql = "INSERT INTO `clients`(`full_name`, `email`, `phone_number`) VALUES (?,?,?)";
            const [results, fields] = yield (yield provider_db.con).query(sql, [
    ...
    get(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [res, fl] = yield (yield provider_db.con).query(sql, params);
            return res;
        });
    }
}
exports.default = provider_db;
